...
const metadata = buildRoomAgentMessageMetadata({
  ...
  observedEval: {
    ...
    responseQuality: { score: 84, met: ['answered the ask'], missed: [] },
    modeSignals: [{ key: 'research_depth', label: 'Research depth', score: 84 }],
    skillSignals: [{ key: 'research', label: 'Research', score: 84, source: 'observed' }],
    blockers: [],
