...
for (const request of [
  ...
  'Would you mind opening Adobe Illustrator when you get a chance?',
  'Would you be able to open Adobe Illustrator if possible, okay?',
  'Could you do me a favor and open Adobe Illustrator now?',
  'Okay, open Adobe Illustrator already!',
  'Go ahead and open Adobe Illustrator on my Mac.',
  'Could you possibly open Photoshop real quick?',
  'I’d like you to focus Slack, please.',
