#!/usr/bin/env python3
"""
BlackSwan LLM v4 — DPO alignment training.

Changes from v3:
  - Uses all 7K DPO samples (was capped at 2K)
  - Longer max_length: 2048 (was 1024)
  - LoRA rank 64 (matched to SFT)
  - Loads from v4 SFT checkpoint
...
def main():
    parser = argparse.ArgumentParser(description="DPO alignment for BlackSwan LLM v4")
