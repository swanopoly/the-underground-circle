...
const AGENT_WORKTREE_OWNER_RULES: AgentWorktreeOwnerRule[] = [
  ...
  },
  {
    ...
    matchers: [
      ...
      /^scripts\/(?:chat-planner|chat-recording|persisted-chat-metadata|chat-agent-targets|chat-design-task-card|chat-desktop-attachment-routing|chat-failure-recovery|predictive-chat-commands|user-task-pipelines)-smoketest\.ts$/,
  ...
  },
  {
    ...
    matchers: [
      ...
      /^scripts\/(?:app-automation-control-surfaces|agent-app-capability-buildout|design-app-|engineering-cad|adobe-creative-cloud-apps)/,
    ],
    canonicalDocs: [
      'docs/AGENTS_ROADMAP.md',
      'docs/UC_APP_STACK_REFERENCE.md',
  ...
  },
  {
    ...
    matchers: [
      ...
      /^scripts\/(?:chat-computer|computer-app|computer-task|computer-capability-expansion|desktop-|browser-|photoshop-save-dialog|local-desktop)/,
  ...
  },
  {
    ...
    matchers: [
      ...
      /^scripts\/approval-payload-smoketest\.ts$/,
    ],
    canonicalDocs: [
      'docs/AGENTS_ROADMAP.md',
      'docs/UC_APP_STACK_REFERENCE.md',
  ...
  },
  {
    ...
    matchers: [
      /^docs\/(?:CHAT_APP_AUTOMATION_DIRECTION|CURSOR_AGENT_FEATURE_PARITY_PLAN|DESKTOP_MANIPULATION_PLAN|SWANBOT_OPENSWAN_PIPELINE_IMPLEMENTATION_PLAN|SWANBOT_PIPELINE_RESEARCH)_/,
