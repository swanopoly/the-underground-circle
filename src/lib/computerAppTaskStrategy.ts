  ...
  switch (id) {
    case 'browser_semantic':
      return {
        ...
        actionOrder: ['browser.set_toggle for exact checkbox/switch/radio state', 'browser.click_role', 'browser.fill_field', 'browser.press_key', 'Stagehand-style semantic action only for ambiguous dynamic UI'],
        ...
        recommendedTools: ['browser.open_url', 'browser.dom_snapshot', 'browser.verification_state', 'browser.set_toggle', 'browser.click_role', 'browser.fill_field', 'browser.press_key', 'browser.screenshot'],
    ...
    case 'approval_sensitive_browser':
      return {
        ...
        actionOrder: ['browser.set_toggle for exact non-consequential checkbox/switch/radio state', 'browser.click_role for navigation', 'browser.fill_field for non-secret fields', 'browser.fill_credential_field when available', 'draft/stage carts, posts, replies, bookings, or records before final action'],
        ...
        recommendedTools: ['browser.open_url', 'browser.dom_snapshot', 'browser.verification_state', 'browser.set_toggle', 'browser.click_role', 'browser.fill_field', 'browser.screenshot', 'vault.resolve_for_task', 'approvals.request'],
    ...
    case 'desktop_semantic':
      return {
        ...
        observeFirst: ['desktop.app_reachability when starting or after unexpected tool failures', 'desktop.observe_app (one round trip: window state + a11y + Δ diff + next-step suggestion)', 'desktop.focus_app or desktop.launch_app', 'desktop.screenshot when visual confirmation matters'],
        ...
        recommendedTools: ['desktop.app_reachability', 'desktop.observe_app', 'desktop.list_running_apps', 'desktop.window_state', 'desktop.launch_app', 'desktop.focus_app', 'desktop.read_a11y_tree', 'desktop.click_element', 'desktop.set_element_value', 'desktop.menu_click', 'desktop.type_text', 'desktop.paste_text', 'desktop.press_keys', 'desktop.screenshot'],
    ...
    case 'productivity_app_control':
      return {
        ...
        recommendedTools: ['desktop.app_reachability', 'desktop.observe_app', 'desktop.list_running_apps', 'desktop.window_state', 'desktop.launch_app', 'desktop.focus_app', 'desktop.read_a11y_tree', 'desktop.click_element', 'desktop.set_element_value', 'desktop.menu_click', 'desktop.type_text', 'desktop.paste_text', 'desktop.press_keys', 'desktop.screenshot', 'approvals.request'],
