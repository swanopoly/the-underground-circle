...
export const CIRCLE_INTEGRATION_CATALOG: CircleIntegrationCatalogItem[] = [
  ...
  },
  {
    ...
    color: '#10A37F',
    group: 'ai_agents_services',
    description: 'Current GPT-5.6, GPT-5.5, GPT-5.4, GPT-4.1, and o3 reasoning models direct from OpenAI with your own key.',
    relationships: ['GPT-5.6', 'GPT-5.5 / 5.4', 'o3 reasoning'],
  ...
  },
  {
    ...
    color: '#4285F4',
    group: 'ai_agents_services',
    description: 'Current Gemini 3.x Flash and Flash-Lite models via Google AI Studio, with long-context multimodal support.',
    relationships: ['Gemini 3.6 Flash', 'Gemini 3.5 Flash-Lite', 'Multimodal'],
  ...
  },
  {
    ...
    color: '#F97316',
    group: 'ai_agents_services',
    description: 'Low-latency GPT-OSS, Compound, and Llama inference on Groq infrastructure for agent-heavy workloads.',
    relationships: ['GPT-OSS', 'Groq Compound', 'Llama'],
  ...
  },
  {
    ...
    relationships: ['Mistral Medium 3.5', 'Mistral Small 4', 'Codestral'],
  ...
  },
  {
    ...
    color: '#39594D',
    group: 'ai_agents_services',
    description: 'Current Command A chat and reasoning models plus Embed and Rerank for enterprise retrieval agents.',
    relationships: ['Command A Plus', 'Command A Reasoning', 'Rerank'],
  ...
  },
  {
    ...
    relationships: ['DeepSeek V4 Pro', 'DeepSeek V4 Flash', 'Reasoning'],
  ...
  },
  {
    ...
    relationships: ['GLM-5.1', 'Tool use', 'Multilingual'],
  ...
  },
  {
    ...
    relationships: ['MiniMax M2.7', 'High-speed', 'Long context'],
