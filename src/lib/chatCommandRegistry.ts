...
export const CHAT_COMMAND_REGISTRY: ChatCommandDefinition[] = [
  ...
  { id: 'wiki', routeId: 'local_knowledge', command: '/wiki', insertText: '/wiki ', title: 'Wiki Search', description: 'Search the internal Knowledge Wiki.', category: 'knowledge', keywords: ['knowledge', 'search', 'docs'] },
