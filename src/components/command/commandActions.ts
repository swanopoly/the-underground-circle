...
export function buildAppActions(navigate: (screen: string, params?: any) => void, circleId?: string): Action[] {
  ...
  actions.push(
    ...
    { id: 'learn-wiki',     name: 'Wiki',             section: 'Learn', perform: () => navigate('Wiki'),     keywords: 'wiki articles knowledge ai agents science cities reference glossary' },
  );
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  actions.push(
    { id: 'search-wiki',    name: 'Search Wiki...',   section: 'Search', keywords: 'wiki search article ai agent science cities reference', perform: () => navigate('Wiki') },
