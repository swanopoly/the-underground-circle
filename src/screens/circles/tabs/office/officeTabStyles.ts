...
export const styles = StyleSheet.create({
  ...
  editLabel: { fontSize: 8, color: '#888', fontFamily: 'monospace', fontWeight: '800', letterSpacing: 0.8 },
  editItems: { gap: 5, flexDirection: 'row', paddingRight: 8 },
  editItemSlot: { width: 72, height: 68, position: 'relative' as const },
  editItem: {
    alignItems: 'center', justifyContent: 'center',
    width: 72, height: 68,
    borderRadius: 8, borderWidth: 1, borderColor: '#2a2a2a', backgroundColor: '#000000',
    gap: 1, paddingHorizontal: 3, paddingVertical: 3,
    ...(Platform.OS === 'web' ? { cursor: 'pointer' } as any : {}),
  },
  editItemActive: {
    borderColor: '#ffffff30', backgroundColor: '#ffffff10',
  ...
  editItemIcon: { fontSize: 20, lineHeight: 22 },
  editItemName: { fontSize: 8, color: '#aaa', fontFamily: 'monospace', fontWeight: '800', textAlign: 'center' },
  editItemDesc: { fontSize: 7, color: '#555', fontFamily: 'monospace', maxWidth: 66, textAlign: 'center', lineHeight: 8 },
  editToolbarHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 },
  editToolbarActions: { flexDirection: 'row', gap: 4 },
  editActionBtn: {
    minHeight: 28, paddingHorizontal: 7, paddingVertical: 2,
    alignItems: 'center', justifyContent: 'center',
    borderRadius: 5, borderWidth: 1,
    ...(Platform.OS === 'web' ? { cursor: 'pointer' } as any : {}),
  },
  editActionBtnText: { fontSize: 8, fontWeight: '800', fontFamily: 'monospace' },
  editCatalogWrap: {
    position: 'relative' as const,
  },
  editFilterRail: {
    flexDirection: 'row' as const, alignItems: 'center' as const,
    gap: 4, paddingBottom: 5, paddingRight: 8,
  },
  editFilterDivider: {
    width: 1, height: 16, marginHorizontal: 2, backgroundColor: '#263244',
  },
  editCatTab: {
    flexDirection: 'row' as const, alignItems: 'center' as const, gap: 4,
    height: 28, paddingHorizontal: 7, paddingVertical: 0,
  ...
  editScrollArrow: {
    width: 20, height: 64, borderRadius: 5, borderWidth: 1,
    backgroundColor: '#0a0a0a90', alignItems: 'center' as const, justifyContent: 'center' as const,
    zIndex: 2,
  },
  editScrollArrowLeft: { marginRight: 3 },
  editScrollArrowRight: { marginLeft: 3 },
  editScrollArrowText: {
