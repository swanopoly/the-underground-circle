                  ...
                  return (
                    <Pressable
                      ...
                      style={({ hovered, pressed }: any) => [
                        ...
                        hovered && enabled && { borderColor: '#6366f166', backgroundColor: '#6366f114', transform: [{ translateY: -1 }] },
                        pressed && { transform: [{ scale: 0.98 }] },
                      ]}
                    >
                      <View style={styles.skillHeader}>
                        <Text style={[styles.skillName, enabled && { color: '#6366f1' }]}>{skill.displayName}</Text>
          ...
          <View style={styles.footer}>
            ...
            <Pressable
              ...
              style={({ hovered, pressed }: any) => [
                styles.doneBtn,
                Platform.OS === 'web' && { transition: 'all 0.15s ease' },
                hovered && { borderColor: 'rgba(99, 102, 241, 0.67)', backgroundColor: '#6366f128', transform: [{ translateY: -1 }] },
...
const styles = StyleSheet.create({
  ...
  skillRowEnabled: { borderColor: '#6366f144', backgroundColor: '#6366f108' },
  ...
  toggleOn: { color: '#6366f1', borderColor: 'rgba(99, 102, 241, 0.67)', backgroundColor: '#6366f118' },
  ...
  doneBtnText: { color: '#6366f1', fontSize: 10, fontWeight: '900', letterSpacing: 0.6, fontFamily: 'monospace' },
});
